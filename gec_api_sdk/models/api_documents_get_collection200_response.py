...
class ApiDocumentsGetCollection200Response(BaseModel):
    """
    ApiDocumentsGetCollection200Response
    """ # noqa: E501
    member: List[DocumentJsonldDocumentRead]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ApiDocumentsGetCollection200Response) in the input: " + _key)

        _obj = cls.model_validate({
            "member": [DocumentJsonldDocumentRead.from_dict(_item) for _item in obj["member"]] if obj.get("member") is not None else None,
