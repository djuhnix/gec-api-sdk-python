...
class MemberPublicViewPublicRead(BaseModel):
    """
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="Anonymised display name computed from initials: \"J. D.\" Real first and last names are never exposed in this projection.", alias="displayName")
    membership_type: Optional[StrictStr] = Field(default=None, alias="membershipType")
    status: Optional[StrictStr] = None
    city: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "displayName", "membershipType", "status", "city"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in MemberPublicViewPublicRead) in the input: " + _key)
