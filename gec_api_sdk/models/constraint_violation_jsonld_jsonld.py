...
class ConstraintViolationJsonldJsonld(BaseModel):
    """
    ...
    violations: Optional[List[ConstraintViolationJsonViolationsInner]] = None
    detail: Optional[StrictStr] = None
    description: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    title: Optional[StrictStr] = None
    instance: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["@context", "@id", "@type", "status", "violations", "detail", "description", "type", "title", "instance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ConstraintViolationJsonldJsonld) in the input: " + _key)
        ...
        _obj = cls.model_validate({
            ...
            "violations": [ConstraintViolationJsonViolationsInner.from_dict(_item) for _item in obj["violations"]] if obj.get("violations") is not None else None,
