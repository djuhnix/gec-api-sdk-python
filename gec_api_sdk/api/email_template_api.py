...
class EmailTemplateApi:
    ...
    def create_email_template(
        self,
        email_template_write: Annotated[EmailTemplateWrite, Field(description="The new EmailTemplate resource")],
        ...
        :param email_template_write: The new EmailTemplate resource (required)
        :type email_template_write: EmailTemplateWrite
    ...
    def _create_email_template_serialize(
        ...
        if email_template_write is not None:
            _body_params = email_template_write
    ...
    def list_email_templates_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[EmailTemplateRead]]:
        """Retrieves the collection of EmailTemplate resources.
    ...
    def update_email_template(
        self,
        id: Annotated[StrictStr, Field(description="EmailTemplate identifier")],
        email_template_write: Annotated[EmailTemplateWrite, Field(description="The updated EmailTemplate resource")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: EmailTemplate identifier (required)
        :type id: str
        :param email_template_write: The updated EmailTemplate resource (required)
        :type email_template_write: EmailTemplateWrite
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
