...
class MemberApi:
    ...
    def create_member(
        self,
        member_write: Annotated[MemberWrite, Field(description="The new Member resource")],
        ...
        :param member_write: The new Member resource (required)
        :type member_write: MemberWrite
    ...
    def update_member(
        self,
        id: Annotated[StrictStr, Field(description="Member identifier")],
        member_write: Annotated[MemberWrite, Field(description="The updated Member resource")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Member identifier (required)
        :type id: str
        :param member_write: The updated Member resource (required)
        :type member_write: MemberWrite
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
