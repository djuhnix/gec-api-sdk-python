...
class TaskApi:
    ...
    def api_tasks_get_collection(
        ...
        _param = self._api_tasks_get_collection_serialize(
            page=page,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApiTasksGetCollection200Response",
        }
    ...
    @validate_call
    def api_tasks_get_collection_with_http_info(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The collection page number")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApiTasksGetCollection200Response]:
        """Retrieves the collection of Task resources.
    ...
    @validate_call
    def api_tasks_get_collection_without_preload_content(
        self,
        page: Annotated[Optional[StrictInt], Field(description="The collection page number")] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_tasks_get_collection_serialize(
        self,
        page,
        _request_auth,
        _content_type,
    ...
    def api_tasks_id_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskJsonldTaskRead]:
        """Retrieves a Task resource.
