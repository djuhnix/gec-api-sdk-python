...
class TaskApi:
    ...
    def create_task(
        self,
        task_write: Annotated[TaskWrite, Field(description="The new Task resource")],
        ...
        :param task_write: The new Task resource (required)
        :type task_write: TaskWrite
    ...
    def update_task(
        self,
        id: Annotated[StrictStr, Field(description="Task identifier")],
        task_write: Annotated[TaskWrite, Field(description="The updated Task resource")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Task identifier (required)
        :type id: str
        :param task_write: The updated Task resource (required)
        :type task_write: TaskWrite
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
