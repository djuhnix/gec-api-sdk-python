...
json = "{}"
# create an instance of MemberMemberRead from a JSON string
member_member_read_instance = MemberMemberRead.from_json(json)
# print the JSON string representation of the object
print(MemberMemberRead.to_json())

# convert the object into a dict
member_member_read_dict = member_member_read_instance.to_dict()
# create an instance of MemberMemberRead from a dict
member_member_read_from_dict = MemberMemberRead.from_dict(member_member_read_dict)
```
